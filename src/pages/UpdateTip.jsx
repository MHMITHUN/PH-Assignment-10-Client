...
const UpdateTip = () => {
    ...
    const fetchTip = async () => {
        try {
            ...
            if (tip.userEmail !== user?.email) {
                toast.error('You are not authorized to edit this tip');
                navigate('/my-tips');
                return;
            }
            ...
            setFormData({
                ...
                difficultyLevel: tip.difficultyLevel,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`${API_URL}/api/tips/${id}`, formData);
                ...
                <div className="card">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Edit your gardening wisdom and share updates
                        </p>
                    </div>
